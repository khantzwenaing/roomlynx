      ...
      <div className="space-y-2">
        ...
        >
          ...
          <SelectContent className="text-lg">
            <SelectItem value="single" className="text-lg py-3">
              Single
            </SelectItem>
            <SelectItem value="double" className="text-lg py-3">
              Double
            </SelectItem>
            <SelectItem value="suite" className="text-lg py-3">
              Suite
            </SelectItem>
            <SelectItem value="deluxe" className="text-lg py-3">
              Deluxe
            </SelectItem>
          </SelectContent>
        </Select>
